...
print("Name: " + family["father"]["name"] + ", Quote: " + family["father"]["quotes"][randrange(len(family["father"]["quotes"]))])
print("Name: " + family["mother"]["name"] + ", Quote: " + family["mother"]["quotes"][randrange(len(family["mother"]["quotes"]))])
for i in range(len(family["children"])):
    print("Name: " + family["children"][i]["name"] + ", Quote: " + family["children"][i]["quotes"][randrange(len(family["children"][i]["quotes"]))])
